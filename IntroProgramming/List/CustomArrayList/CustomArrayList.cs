...
namespace CustomArrayList
{
    class CustomArrayList
    {
        ...
        ///<summary>
        ///Returns the actual list lenght
        ///<summary>
        public int Count
        {
            get
        ...
        /// <summary>
        /// Insert the specified element at a given
        ...
        /// <exception cref="System.IndexOutRangeException">
        /// Index is invalid
        /// </exception>
        ...
        /// </summary>
        /// <param name="item">The item to by checked</param>
        /// <returns>If the item exist</returns>
