...
{
    /// <summary>
    /// Represent dynamic list implementation
    /// </summary>
    public class DynamicList
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException">Index is invalid
        /// </exception>
        ...
        /// </summary>
        /// <param name="item">The iten for removal</param>
        /// <returns>The index of the element or -1 if does exist</returns>
        ...
        /// <returns>The index of the first occurrence of the element in the list or -1 when not found
        /// </returns>
        ...
        /// <summary>
        /// Check if specified element exists in the list
        /// </summary>
        /// <param name="item">The item you are searching for</param>
        /// <returns>True if the element exists or false stherwise</returns>
        ...
        /// </summary>
        /// <param name="index">The position of element [0 ... count-1]</param>
